                  ...
                  <>
                    <div className="grid grid-cols-5 gap-4 mt-10">
                      {skills.map((item) => (
                        <div
                          key={item.id}
                          className="border bg-white hover:border-blue-600 hover:bg-gray-100  border-gray-400  grid place-items-center py-5 rounded-lg hover:shadow-xl transition duration-200"
                        >
                ...
                {tab === "educations" && (
                  <div className="mt-8">
                    {education.map((item) => (
                      <div
                        key={item.id}
                        className="border mb-5 border-gray-200 hover:border-blue-600 bg-gray-100 px-5 py-3 rounded-lg"
                      >
                ...
                {tab === "experience" && (
                  <div className="mt-8">
                    {experience.map((item) => (
                      <div
                        key={item.id}
                        className="border border-gray-200 hover:border-blue-600 bg-gray-100 px-5 py-3 rounded-lg"
                      >
